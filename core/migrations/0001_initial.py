# Generated by Django 4.2.7 on 2024-02-15 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.course', verbose_name='Курс')),
        ...
        migrations.AddField(
            model_name='employee',
            name='speciality',
            field=models.ManyToManyField(to='core.teacher', verbose_name='Должность'),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
